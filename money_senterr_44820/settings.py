"""
Django settings for money_senterr_44820 project.
...
ROOT_URLCONF = 'money_senterr_44820.urls'
...
WSGI_APPLICATION = 'money_senterr_44820.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "money_senterr_44820 API",
    "DESCRIPTION": "API documentation for money_senterr_44820 App",
    "VERSION": "v1",
}
